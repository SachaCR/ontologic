...
The **Message Relay** is the bridge between your outbox table and your event bus. Its job is to read domain events that were persisted by the [repository](../domain-model/repository.md#saving-entities-and-events-together) and forward them to the rest of your system via the [event bus](./event-bus.md).
