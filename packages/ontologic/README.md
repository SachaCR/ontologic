...
**[`packages/library-example`](https://github.com/SachaCR/ontologic/tree/main/packages/library-example)**

### Smaller examples

Focused examples (entity, invariants, events, use cases) are in the [`src/examples/`](https://github.com/SachaCR/ontologic/tree/main/packages/ontologic/src/examples) directory — a credit balance aggregate and an order lifecycle.
